...
vim.api.nvim_set_hl(0, "MatchParen", { bg = yellow, fg = bg0 })

vim.api.nvim_set_hl(0, "Search", { bg = yellow, fg = bg0 })
vim.api.nvim_set_hl(0, "IncSearch", { bg = yellow, fg = bg0 })
vim.api.nvim_set_hl(0, "CurSearch", { bg = yellow, fg = bg0 })
